% clear all;
% clc
% I = imread('D:\digiART_Dataset2\hybrid\segmentImages\undistorted_image_4_IMG_5444.tif');
% I = imresize(I, 0.1);
% 
% K = 8;
% Ikm = Km2(I,K);
% 
% imwrite(Ikm, 'D:\digiART_Dataset2\hybrid\undistorted_image_4_IMG_5444.tif')
% imshow(Ikm)
